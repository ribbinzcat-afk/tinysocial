...
export const PROMPT_DEFS = [
    ...
    },
    {
        ...
        default: [
            ...
            "- Reference images/stickers only by the exact slug shown in the image list. If nothing matches, omit the img/sticker attribute rather than inventing a slug.",
